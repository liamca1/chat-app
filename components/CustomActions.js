...
export default class CustomActions extends React.Component {
  ...
  render() {
    return (
      <TouchableOpacity style={[styles.container]} onPress={this.onActionPress} accessibilityLabel="more options" accessibilityHint="Choose to send an image or your geolocation">
